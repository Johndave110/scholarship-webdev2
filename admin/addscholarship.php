...
<div class="max-w-3xl mx-auto px-6 mt-8">
    ...
    <h2 class="text-2xl font-bold mt-2 mb-4">Add Scholarship</h2>
    ...
    <form action="" method="post" class="bg-white rounded-xl shadow p-6 space-y-4">
        <div>
            ...
            <input type="text" name="title" id="title" value="<?= $scholarship["title"] ?? "" ?>" class="mt-1 w-full rounded-md border-slate-300 focus:border-brand-blue focus:ring-brand-blue" />
        ...
        <div>
            ...
            <textarea name="description" id="description" class="mt-1 w-full rounded-md border-slate-300 focus:border-brand-blue focus:ring-brand-blue" rows="4"><?= $scholarship["description"] ?? "" ?></textarea>
        ...
        <div>
            ...
            <textarea name="requirements" id="requirements" class="mt-1 w-full rounded-md border-slate-300 focus:border-brand-blue focus:ring-brand-blue" rows="4"><?= $scholarship["requirements"] ?? "" ?></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="date" name="deadline" id="deadline" value="<?= $scholarship["deadline"] ?? "" ?>" class="mt-1 w-full rounded-md border-slate-300 focus:border-brand-blue focus:ring-brand-blue" />
            ...
            <div>
                ...
                <input type="number" name="total_slots" id="total_slots" value="<?= $scholarship["total_slots"] ?? "" ?>" class="mt-1 w-full rounded-md border-slate-300 focus:border-brand-blue focus:ring-brand-blue" />
                <p class="text-sm text-red-600 mt-1"><?= $errors["total_slots"] ?? "" ?></p>
            </div>
        </div>

        <div>
            <button type="submit" class="inline-flex items-center px-5 py-2.5 rounded-md bg-brand-green text-white hover:bg-green-600">Save Scholarship</button>
        </div>
    </form>
</div>
