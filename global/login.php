...
<body class="min-h-screen bg-slate-50 text-slate-800">
    <nav class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
            ...
            <a href="/webdev-2-Scholarship/global/Register.php" class="hidden sm:inline-flex px-3 py-2 rounded-md bg-brand-blue text-white hover:bg-blue-700">Create account</a>
        </div>
    </nav>
    ...
    <main class="max-w-md mx-auto mt-12 px-4">
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <p class="text-sm text-slate-600 mt-4">Don't have an account?
                <a href="/webdev-2-Scholarship/global/Register.php" class="text-brand-blue hover:underline">Register</a>
            </p>
        </div>
    </main>
