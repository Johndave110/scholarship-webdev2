        ...
        <div class="max-w-7xl mx-auto px-5">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-6">
                    <a href="/webdev-2-Scholarship/global/index.php" class="text-slate-700 hover:text-brand-blue transition">Home</a>
                    <a href="/webdev-2-Scholarship/student/browsescholarships.php" class="text-slate-700 hover:text-brand-blue transition">Browse</a>
                    <a href="/webdev-2-Scholarship/global/login.php" class="text-slate-700 hover:text-brand-blue transition">Login</a>
                    <a href="/webdev-2-Scholarship/global/Register.php" class="inline-flex items-center px-4 py-2 rounded-md bg-brand-blue text-white hover:bg-blue-700 transition">Sign Up</a>
                </div>
                <!-- Mobile menu toggle -->
                <div class="md:hidden">
            ...
            <div id="mobileMenu" class="md:hidden hidden border-t">
                <div class="py-3 space-y-2">
                    <a href="/webdev-2-Scholarship/global/index.php" class="block px-2 py-2 rounded hover:bg-slate-100">Home</a>
                    <a href="/webdev-2-Scholarship/student/browsescholarships.php" class="block px-2 py-2 rounded hover:bg-slate-100">Browse</a>
                    <a href="/webdev-2-Scholarship/global/login.php" class="block px-2 py-2 rounded hover:bg-slate-100">Login</a>
                    <a href="/webdev-2-Scholarship/global/Register.php" class="block px-2 py-2 rounded bg-brand-blue text-white hover:bg-blue-700">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <header class="pt-24 bg-gradient-to-br from-brand-blue to-blue-600 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center py-24">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                <a href="/webdev-2-Scholarship/student/browsescholarships.php" class="inline-flex items-center px-5 py-3 rounded-md bg-brand-green text-white font-semibold shadow hover:bg-green-600 transition">Browse Scholarships</a>
                <a href="/webdev-2-Scholarship/global/login.php" class="inline-flex items-center px-5 py-3 rounded-md border border-white/70 text-white hover:bg-white/10 transition">Login</a>
            </div>
        </div>
    </header>
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
        ...
        <section id="how" class="text-center bg-slate-100 rounded-xl py-16">
            <div class="max-w-3xl mx-auto px-4">
                ...
                <a href="/webdev-2-Scholarship/global/Register.php" class="inline-flex items-center px-6 py-3 rounded-md bg-brand-blue text-white hover:bg-blue-700 transition text-lg">Get Started</a>
            </div>
        </section>
    </main>
